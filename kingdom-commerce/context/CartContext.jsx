...
export function CartProvider({ children }) {
  ...
  function removeFromCart(id, selectedSize) { dispatch({ type: 'REMOVE', id, selectedSize }); }
  ...
  return (
    <CartContext.Provider value={{ items: state.items, itemCount, subtotal, addToCart, removeFromCart, updateQty, clearCart }}>
      {children}
