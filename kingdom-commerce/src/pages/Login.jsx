    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '100px 24px 60px' }}>
      ...
      >
        ...
        <button
          ...
          style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, padding: '13px', background: 'transparent', border: '1px solid #444', color: 'var(--white)', fontSize: '0.85rem', cursor: 'pointer', marginBottom: 24, transition: 'border-color 0.2s' }}
        ...
        <p style={{ textAlign: 'center', marginTop: 24, color: 'var(--gray)', fontSize: '0.85rem' }}>
          ...
          <Link to="/register" style={{ color: 'var(--gold)' }}>Create one</Link>
        </p>
      </motion.div>
    </div>
  );
