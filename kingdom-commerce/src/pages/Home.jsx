...
const DEMO_PRODUCTS = [
  ...
  { id: 'd2', name: 'Kingdom Crewneck', category: 'Apparel', price: 165, images: ['https://images.unsplash.com/photo-1556821840-3a63f15732ce?w=600&q=80'], isSale: false },
...
export default function Home() {
  ...
  const featured = products.length > 0 ? products : DEMO_PRODUCTS;
    ...
    <div>
      ...
      <section style={{ minHeight: '100vh', position: 'relative', display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          ...
          >
            ...
            <h1 style={{ fontFamily: 'Playfair Display, serif', fontSize: 'clamp(3rem, 7vw, 5.5rem)', fontWeight: 700, lineHeight: 1.05, marginBottom: 28 }}>
              Dress Like<br />Royalty
            </h1>
            <p style={{ color: 'var(--gray-light)', fontSize: '1.05rem', lineHeight: 1.7, maxWidth: 480, marginBottom: 40 }}>
              Premium pieces crafted for those who move through the world with intention. Every stitch. Every detail. Perfected.
            </p>
            <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
              ...
              <Link to="/shop?category=new">
                <button className="btn-outline">New Arrivals</button>
              </Link>
            </div>
          </motion.div>
        </div>
        ...
        <div style={{ position: 'absolute', bottom: 40, left: '50%', transform: 'translateX(-50%)', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
          <motion.div
            ...
            style={{ width: 1, height: 50, background: 'linear-gradient(to bottom, transparent, var(--gold))' }}
          />
        </div>
      </section>
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 32, textAlign: 'center' }}>
            {[
              ...
              { num: 'Free', label: 'Returns & Exchanges' },
            ].map((s) => (
              <div key={s.label}>
      ...
      <section style={{ padding: '100px 0' }}>
        <div className="container">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 48, flexWrap: 'wrap', gap: 16 }}>
            ...
            <Link to="/shop" style={{ color: 'var(--gold)', fontSize: '0.8rem', letterSpacing: 2, textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 24 }}>
            {CATEGORIES.map((cat) => (
              ...
              >
                <Link to={`/shop?category=${cat.label.toLowerCase()}`}>
                  <div style={{ position: 'relative', aspectRatio: '4/5', overflow: 'hidden' }}>
                    ...
                    <div style={{ position: 'absolute', bottom: 24, left: 24 }}>
                      ...
                      <span style={{ fontSize: '0.7rem', letterSpacing: 2, color: 'var(--gold)', textTransform: 'uppercase' }}>
                        Shop Now →
                      </span>
                    </div>
                  </div>
      ...
      <section style={{ background: 'var(--gold)', padding: '80px 0', textAlign: 'center' }}>
        <div className="container">
          ...
          <h2 style={{ fontFamily: 'Playfair Display, serif', fontSize: 'clamp(1.8rem, 4vw, 3rem)', color: 'var(--black)', marginBottom: 20, maxWidth: 700, margin: '0 auto 20px' }}>
            Excellence Is Not a Standard.<br />It Is a Requirement.
          </h2>
          <p style={{ color: 'rgba(0,0,0,0.7)', maxWidth: 540, margin: '0 auto 32px', lineHeight: 1.7 }}>
            Every item in our collection passes through 47 quality checkpoints before it reaches your hands. We don't settle. Neither should you.
          </p>
          <Link to="/shop">
            <button style={{
              padding: '14px 40px',
