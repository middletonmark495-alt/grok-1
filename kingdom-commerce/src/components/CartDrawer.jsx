          ...
          <>
            ...
            >
              ...
              <div style={{ padding: '24px', borderBottom: '1px solid #2a2a2a', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <button onClick={onClose} style={{ background: 'none', color: 'var(--white)', fontSize: '1.3rem' }}>
                  <FiX />
                </button>
              </div>
              ...
              <div style={{ flex: 1, overflowY: 'auto', padding: '24px' }}>
                {items.length === 0 ? (
                  <div style={{ textAlign: 'center', padding: '60px 0', color: 'var(--gray)' }}>
                    ...
                    <p style={{ fontFamily: 'Playfair Display, serif', fontSize: '1.2rem', marginBottom: 8, color: 'var(--white)' }}>
                      Your bag is empty
                    </p>
                    <p style={{ fontSize: '0.85rem', marginBottom: 24 }}>Add items to get started</p>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
                    {items.map((item) => (
                      <div
                        ...
                        style={{ display: 'flex', gap: 16, paddingBottom: 24, borderBottom: '1px solid #2a2a2a' }}
                      >
                        ...
                        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 6 }}>
                          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                            ...
                            <button
                              ...
                              style={{ background: 'none', color: 'var(--gray)', fontSize: '0.9rem', flexShrink: 0 }}
                            >
                              <FiTrash2 />
                            </button>
                          </div>
                          {item.selectedSize && (
                            <span style={{ fontSize: '0.75rem', color: 'var(--gray)', textTransform: 'uppercase', letterSpacing: 1 }}>
                          ...
                          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 'auto' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: 12, border: '1px solid #333', padding: '4px 12px' }}>
                              <button
                                ...
                                style={{ background: 'none', color: 'var(--gray)', fontSize: '0.8rem' }}
                              >
                                <FiMinus />
                              </button>
                              ...
                              <button
                                onClick={() => updateQty(item.id, item.selectedSize, item.qty + 1)}
                                style={{ background: 'none', color: 'var(--white)', fontSize: '0.8rem' }}
                              >
                                <FiPlus />
                              </button>
                            </div>
              ...
              {items.length > 0 && (
                <div style={{ padding: '24px', borderTop: '1px solid #2a2a2a' }}>
                  ...
                  <button
                    onClick={onClose}
                    style={{ width: '100%', background: 'none', color: 'var(--gray)', fontSize: '0.8rem', marginTop: 12, letterSpacing: 1 }}
                  >
                    Continue Shopping
                  </button>
                </div>
